...
{
    public class Level_Practice : Level
    {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            {
                _spriteBatch.Begin();
                _spriteBatch.DrawString(_bitmapFont, "The game is Paused", _camera.Origin - new Vector2(100f, -30), Color.White);
                _spriteBatch.End();
            }
